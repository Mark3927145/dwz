...
if (!is_file('./codepay/qrcode.php')) { //如果存在这个文件 表示codepay目录上传 使用本地资源否则用远程资源
    $codepay_path = "http://codepay.kjkl8.com";
} else {
...
function create_link($params, $codepay_key, $host = "")
{
    ...
    $apiHost = $host ? $host : "http://codepay.kjkl8.com/creat_order/?";
    ...
    <div class="body">
        ...
        <div class="mod-ct">
            ...
            <div class="amount" style="position: relative;"><span id="money">￥<?php echo $price ?></span>
                <div style="position: absolute;font-size: 10px;top: 29px;left: 75%;"><a href="#" class="copy" id="copy" data-clipboard-text="<?php $user_data['money'] ?>">复制金额</a></div>
            </div>
